...
function Animation() {
  ...
  return (
    <div   data-scroll data-scroll-section  data-scroll-speed = ".2"  className="flex items-center justify-center w-full h-screen bg-zinc-900 gap-10">
        <div className=" Heading w-full h-screen font-bold font-serif text-center  text-7xl mt-[20%] text-orange-600">
          <div className="heading1 mb-5 border-2 border-black p-4 rounded-xl ml-2 "> <h1>Drag </h1> </div>
          <div className="heading2 mb-5 border-2 border-black p-4 rounded-xl ml-2">  <h1>Imagination </h1> </div>
